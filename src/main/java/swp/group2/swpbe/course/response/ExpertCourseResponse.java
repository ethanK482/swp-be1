...
public class ExpertCourseResponse extends Course {
    ...
    public ExpertCourseResponse(int totalUserBuy, double income, String expertId, Double price, String description, String banner_url, String name, String topicId, String state) {
